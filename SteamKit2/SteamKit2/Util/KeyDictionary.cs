...
{
    /// <summary>
    /// Provides the public key to a <see cref="SteamClient"/> instance.
    /// </summary>
    public interface IKeyDictionary
    {
        /// <summary>
        ...
        byte[] GetPublicKey(EUniverse eUniverse);
    }
    ...
    /// types.
    /// </summary>
    public class KeyDictionary : IKeyDictionary
    {
